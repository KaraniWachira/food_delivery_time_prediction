...
for (model_name in models) {
  ...
  model <- switch(
    model_name,
    lm = linear_reg(),
    rpart = decision_tree(mode = "regression"),
    rf = rand_forest(mode = "regression")
  )

  # Create a recipe
  recipe_formula <- as.formula(paste("y_train ~ ."))
...
for (model_name in models) {
  cat(model_name, ":\n")
  cat("Trained model:", results[[model_name]]$trained_model, "\n")
}
